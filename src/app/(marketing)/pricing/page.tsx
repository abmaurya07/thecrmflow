    ...
    <section className="flex flex-col py-8 mx-4 md:max-w-[64rem] md:py-12 lg:mb-16">
      <div className="mx-auto flex w-full flex-col gap-4 md:max-w-[58rem] mb-8">
        ...
        <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
          Unlock all the features for your real estate CRM.
        </p>
      </div>
      <Separator />
    ...
    <div className="mb-10">
      ...
      <div className="">
        ...
        <div className="flex justify-center mb-12">
          ...
          <div className="text-sm font-bold ml-2">Yearly</div>
        </div>
        <div className="flex justify-center items-center gap-8 flex-wrap">
          <PriceCard product={basic} timeInterval={timeInterval} />
          <PriceCard product={pro} timeInterval={timeInterval} />
        </div>
      </div>
    </div>
  );
